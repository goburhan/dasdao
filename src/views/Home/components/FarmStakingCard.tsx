...
const FarmedStakingCard = () => {
  ...
  return (
    <div className="farmstaking  ">
      <div className="text-2xl font-bold  text-greenmain ">Farms & Staking</div>

      <Baby>
        <div>
          <div className=" p-2 rounded-xl">
            <span className="text-white">RV2 to Harvest</span>
            <CakeHarvestBalance earningsSum={earningsSum} />
            <Label>~${(eggPrice * earningsSum).toFixed(2)}</Label>
          </div>
          <div className="mt-2  p-2 rounded-xl">
            <span className="text-white">RV2 in Wallet</span>

...
const Farms: React.FC<FarmsProps> = (farmsProps) => {
  ...
  return (
    <Page>
      ...
      >
        {tokenMode ? 'Stake Tokens to Earn with DASDAO Pools' : 'Stake Tokens to Earn with DASDAO Farms'}
      </Heading>
     ...
     <FarmTabButtons stakedOnly={stakedOnly} setStakedOnly={setStakedOnly} />
      ...
      <div className="mb-10" />
          ...
          {/* <div className="grid grid-cols-2 launchpage text-left mb-10"> */}
            <div className="p-5 leading-7 text-lg text-white">
            <div className=" text-white text-center text-3xl leading-10 mb-4">
            Launch Your Project on Dasdao Now
          </div>
          <div className=" text-white text-xl text-center leading-10 mt-4 mb-4">
              DasdaoSwap supports multiple blockchains through a cross-chain bridge. If you would like to grow with <br/>
              DasdaoSwap, please feel free to apply for our partnership program.</div>
      ...
      <div className="mb-16" />
      <div className=" lg:col-start-3 col-span-1 mb-20 ">
            <Statistics />
          </div>
      <div className="mb-16" />
    </Page>
